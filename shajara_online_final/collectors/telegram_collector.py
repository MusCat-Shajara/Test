...
# Supabase helper (تأكد أن هذا الملف موجود في utils/)
...
# DO NOT commit this file to GitHub if it contains secrets.
...
async def run():
    rows = []
    try:
        # Use the provided StringSession (non-empty validated above)
